# BOUNDLESS PROTOCOL — TCG Workspace
...
- 기능 QA 체크리스트: [`docs/qa_checklist.md`](./docs/qa_checklist.md)
- CSS 아키텍처 책임표: [`docs/css_architecture.md`](./docs/css_architecture.md)
- 코어 안내: [`core/README.md`](./core/README.md)
- 배포 앱 안내: [`vercel/README.md`](./vercel/README.md)
